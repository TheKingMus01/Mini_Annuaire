...
<div class="container">
    ...
    <div class="card-body">
      ...
      <a href="test?action=InsertEtudiant.html"" class="btn btn-primary">Ajouter</a>
    </div>
  </div>
  <br>
  ...
  <div class="card" style="width:400px" id="2">
    <div class="card-body">
      ...
      <a href="test?action=Insert_D" class="btn btn-primary">Ajouter</a>
    </div>
  ...
  <div class="card" style="width:400px" id="1">
    ...
    <div class="card-body">
      ...
      <a href="test?action=Insert_F" class="btn btn-primary">Ajouter</a>
    </div>
  </div>
    </div>
</div>
