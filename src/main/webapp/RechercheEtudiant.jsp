...
<%@page import="com.test.Model.etudiant"%><%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
...
<%etudiant a=new etudiant();
     ...
     ide = request.getParameter("search");

                                    request.setAttribute("listEe", ser.getEtudiantby(ide));
%>
